...
<body>
    <fieldset>
        <div class="titForm">
            ...
            <div class="login">
                <span>Por favor <br> preencha este formulário <br> para redefinir sua senha.</span>
            </div>
            <div class="btn">
                <a class="btn btn-link ml-2" href="/portfolio_php/public/src/routes/Home/welcome.php"> 
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="btn">
                <input type="submit" class="btn-input" value="Redefinir">
            </div>
        </form>
    </fieldset>
</body>
